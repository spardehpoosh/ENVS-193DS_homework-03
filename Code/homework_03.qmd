...
## Checks for Pearson's correlation

Based on the graph in part 1b, there seems to be a linear relationship between soil salinity (mS/cm) and California pickleweed biomass (g). 
